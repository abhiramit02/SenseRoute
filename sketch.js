...
var imgSit;
function preload() {
  imgs.push(loadImage('imgs/profs/image1.png'));
  imgs.push(loadImage('imgs/profs/image2.png'));
  imgs.push(loadImage('imgs/profs/image3.png'));
  imgs.push(loadImage('imgs/profs/image4.png'));
  imgs.push(loadImage('imgs/profs/image5.png'));
  imgs.push(loadImage('imgs/profs/image6.png'));
  imgs.push(loadImage('imgs/profs/image7.png'));
  imgs.push(loadImage('imgs/profs/image8.png'));
  imgs.push(loadImage('imgs/profs/image9.png'));
  imgs.push(loadImage('imgs/profs/image10.png'));
  imgs.push(loadImage('imgs/profs/image11.png'));
  imgs.push(loadImage('imgs/profs/image12.png'));
  imgSit = loadImage('imgs/imagehouse.png');
}
